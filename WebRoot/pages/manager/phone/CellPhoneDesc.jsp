...
<body>
	<div class="main_content">
		<div class="label_bar">
			<strong>你当前的位置：</strong>[手机管理]>[效果展示]
		</div>
		<div class="content">
			<div class="content_info">
				<div class="content_info_left">
					<img alt="展示图" src="" style="width:350px;height:400px;margin-left:5px;;">
				</div>
				<div class="content_info_right">
					<span style="margin-top:10px;margin-bottom:10px;font-size:16px;display:block;font-family:'微软雅黑';">
						新品【12期免息】HTC U Ultra 全网通双屏双卡双待HTC U-1w手机
					</span>
					<table>
						<tr>
							<td width="90px">
							...
							<td>
								<span style="color:red;">5088.00￥</span>
							</td>
						</tr>
						<tr>
							<td width="90px">
						...
						<tr>
							...
							<td>
								<button style="height:30px;border:2px solid #ccc;" onmouseover="this.style.cursor='hand'">-</button>
								<input type="text" style="width:50px;height:30px;border:2px solid #ccc;"> 
								<button style="height:30px;border:2px solid #ccc;" onmouseover="this.style.cursor='hand'">+</button>
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<button class="btn" style="background-color:red;color:#fff;" onmouseover="this.style.cursor='hand'">
									立即购买
								</button>
							</td>
						</tr>
			...
			<div class="content_bottom">
				<div class="content_bottom_top">
					<a href="javascript:changeDiv1()" id="a1" style="border:1px solid #ddFFFF;background-color:#ddFFFF;">基础信息</a>
